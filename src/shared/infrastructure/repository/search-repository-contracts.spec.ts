import { SearchParams } from './search-repository-contracts';

describe('Searchable Repository unit tests', () => {
  it('should initialize page with default value', () => {
  ...
  it('should initialize perPage with default value', () => {
    const sut = new SearchParams();
  ...
  it('should initialize sort with default value', () => {
    const sut = new SearchParams();
  ...
  it('should initialize sortDir with default value', () => {
  ...
  it('should initialize filter with default value', () => {
    const sut = new SearchParams();
